...
8. 좌표의 갯수가 4개일 경우 사각형의 넓이를 구한다.
9. 좌표의 갯수가 3개일 경우 삼각형의 넓이를 구한다.
### 기능 분리
1. 좌표 정보를 괄호 및 쉼표를 분리
2. x, y 좌표의 값을 24 초과 검증
3. 좌표의 갯수가 2개일 경우 직선의 길이를 구한다.
4. 3개일 경우 삼각형의 넓이를 구한다.
5. 4개일 경우 사각형의 넓이를 구한다.